...
export default function Register({ onNavigateLogin, onSuccess }) {
  ...
  return (
    <div className="max-w-md mx-auto my-8 p-8 bg-white rounded-3xl border border-slate-200 shadow-xl space-y-6">
      <div className="text-center space-y-1.5">
        ...
        <p className="text-xs text-slate-500">
          Register to book bus passes, choose seats, and download digital tickets.
        </p>
      </div>
